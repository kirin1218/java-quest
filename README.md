...
> **将来的な有償化の可能性について**: 運用コスト回収や機能拡充のため、将来的に一部機能・API 利用・上位カリキュラム等を**有償化する可能性があります**。現時点では全機能を無償で提供していますが、方針変更が決まり次第、CHANGELOG / README で事前にお知らせします（[LICENSE](./LICENSE) 第 2 項も参照）。
